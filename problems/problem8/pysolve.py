...
Note: this is the backup python version. An alternate version in csolve.c is
much faster.

This module defines one external function solve_episode.

Author: Nimar Arora (feel free to modify, use, or redistribute)
"""
from __future__ import print_function, division

__all__ = ['solve_episode']
...
def solve_episode(physics, sta_list, detections):
  """
  Starting with the physics, and a list of detections this function
  returns a list of events and their associated detections.

  The sta_list object is ignored here. It has been included for convenience
  so that the c-version of this function can easily get it.
...
def invert_detection(physics, det, delslow, delaz):
  ...
  azimuth respectively to get the candidate location.
  """
